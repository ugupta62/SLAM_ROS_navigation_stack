...
# yaw_tolerance = rospy.get_param('/move_base/DWAPlannerROS/yaw_goal_tolerance')
# print('params:',xy_tolerance, yaw_tolerance)
# xy_tolerance = 0.2 #0.05
# yaw_tolerance = 0.2
t_change = True
t_old = None
nav_status= None
...
# print('xy', xy_tolerance)
# print('yaw', yaw_tolerance)
...
def nav_waypoint():  #obstacle range
	...
	if zero_vel>0:
		...
		# rospy.Subscriber('/amcl_pose', PoseWithCovarianceStamped, callback2,  queue_size = 1)
